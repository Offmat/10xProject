...
- Living surfaces (Phase 1–2): playbook `context/foundation/interactive-forms.md`; Cursor rule `.cursor/rules/hotwire-interactive-forms.mdc`; root `AGENTS.md` Architecture pointer; S-03 consumer note on `log-session-confirm-flow/plan.md`. Ready to archive after human confirm.
