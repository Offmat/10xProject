...
- [x] 3.1 Cookbook sections exist and no longer read TBD for §6.5: inspect `context/foundation/test-plan.md` — bc24b84
- [x] 3.2 Full relevant suite still green: `bin/rspec spec/requests/notifications_spec.rb spec/requests/game_sessions_spec.rb spec/requests/friendships_spec.rb` — bc24b84

#### Manual

- [x] 3.3 Skim §6.5: a new contributor could copy the confirm↔history and IDOR unchanged pattern without reading the research doc — bc24b84
- [x] 3.4 Confirm §3 Phase 2 row points at `confirm-path-ownership` once implementation finishes — bc24b84
